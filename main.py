...
from inverse_kinematics import cinematique_inverse, cinematique_inverse2
...
def main(pwm_controller):
    while True:
        ...
        alpha2, beta2 = cinematique_inverse2(POS_X, POS_Y, x, y, LEN_E, LEN_B)

        pwm_controller.set_angle("shoulder", alpha)
        pwm_controller.set_angle("elbow", beta)
        print(x, "\t", y, "\t", alpha, "\t", alpha2, "\t", beta, "\t", beta2)
        # time.sleep(0.1)
