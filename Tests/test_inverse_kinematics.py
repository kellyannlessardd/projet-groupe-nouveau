...
class TestInverseKinematics(unittest.TestCase):
    ...
    def test_zero_position(self):
        ...
        alpha, beta = cinematique_inverse(0, 0, 0, 0, 155, 155)
    ...
    def test_symmetry(self):
        ...
        alpha1, beta1 = cinematique_inverse(0, 0, 100, 100, 155, 155)
        alpha2, beta2 = cinematique_inverse(0, 0, 100, -100, 155, 155)
    ...
    def test_midpoint(self):
        ...
        alpha, beta = cinematique_inverse(0, 0, 80, 80, 155, 155)
